...
public class NavigationManager {
    ...
    private ArrayList<AnchorItem> anchors;

    public void ArrayRetriever(AnchorItem anchor){
        this.anchors.add(anchor);
    }

    public NavigationManager(String Source, String Destination, ArrayList<AnchorItem> anchors){
        this.Source = Source;
